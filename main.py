...
def main(page:Page):
    ...
    search = ElevatedButton(text="Search",width=100,bgcolor='blue',color='white',on_click=lambda _:search_code(inp_search.value))
    ...
    def route_change(route):
        ...
        page.views.append(
            View(
                "/",
                [
                    AppBar(title=Text("hazem"),center_title=True,leading=Icon(icons.HOME),bgcolor='blue',color='white'),
